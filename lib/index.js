  ...
  onBeforeRender = (renderer, scene, camera, geometry, material, group) => {
    ...
    if (this.dirty) {
      ...
      if (this._newFontString && this._text) {
        ...
        m.uniforms.layoutTexture.value = new DataTexture2(data, maxPixelWidth, charsHeight, RGBAFormat2, UnsignedByteType2, UVMapping, ClampToEdgeWrapping, ClampToEdgeWrapping, NearestFilter2, NearestFilter2);

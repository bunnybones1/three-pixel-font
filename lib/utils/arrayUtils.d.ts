...
export declare function getArrWrap<T>(arr: T[], i: number): T;
export declare function getArrNext<T>(arr: T[], item: T): T;
export declare function getArrPrev<T>(arr: T[], item: T): T;
export declare function getArrAround<T>(arr: T[], item: T): T[];
